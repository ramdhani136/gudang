            ...
            <div id="modal-width" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select v-model="form.id_kategori" name="satuan" id="" class="form-control" :disabled="disabled == 1">
                            <option v-for="(kat,index) in kategori" :key="index" :value="kat.id">{{kat.nama}}</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Harga</label>
...
export default {
    ...
    methods: {
        ...
        updateBarang(barang) {
            ...
            this.form.id_kategori = barang.kategori;
        ...
        AccBarang() {
            ...
            swalWithBootstrapButtons.fire({
                title: 'Apakah anda yakin?',
                text: "ingin menerima barang ini!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Iya, Yakin!',
                cancelButtonText: 'Tidak!',
