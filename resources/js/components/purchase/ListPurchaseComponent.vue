...
export default {
  ...
  methods: {
    ...
    getlistRso() {
      axios.get(`/api/listrso/data/purch/${this.$route.params.id}`).then((res) => {
          ...
          if (result.value) {
            ...
            if (this.ketban === this.nilai) {
              if (rs.pr === "N") {
                ...
                this.konfirm.tgl_purchasing = this.DateTime();
                this.konfirm.purchasing = this.ambiluser.name;
                axios.put(`/api/rso/` + rs.nomor_rso, this.konfirm).then((response) => {
                ...
                if (this.upso === this.value) {
                  ...
                  this.konfirm.purchasing = this.ambiluser.name;
                  axios.put(`/api/rso/` + rs.nomor_rso, this.konfirm).then((response) => {
                    axios.get("/api/listrso/" + rs.nomor_rso).then((res) => {
                      axios
                        .post("/api/so", {
