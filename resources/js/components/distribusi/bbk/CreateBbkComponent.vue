        ...
        >
          ...
          <tbody>
            <tr v-for="(listbcm, index) in checker" :key="index">
              ...
              <td>
                {{
                  parseFloat(hitung.qty[index]) * parseFloat(listbcm.kubikasi)
                }}
              </td>
              <td>
                {{ parseFloat(hitung.qty[index]) * parseFloat(listbcm.tonase) }}
              </td>
            </tr>
          </tbody>
        </table>
  ...
  methods: {
    ...
    validqty(index) {
      ...
      for (let i = 0; i < this.checker.length; i++) {
        ...
        this.kubikasi +=
          parseFloat(this.hitung.qty[i]) * parseFloat(this.checker[i].kubikasi);
        this.tonase =
          parseFloat(this.hitung.qty[i]) * parseFloat(this.checker[i].tonase);
      }
    },
    batal() {
      this.$router.push({
    ...
    cekbbk() {
      axios.get("/api/bbk/" + this.up.bbk).then((res) => {
