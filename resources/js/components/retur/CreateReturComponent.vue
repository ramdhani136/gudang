    ...
    <div class="row row-cols-2">
        <div class="col-4">
            <div class="form-group">
                ...
                <input v-model="up.nomor_retur" type="text" class="form-control col-12">
            </div>
            <div class="form-group">
                <label>Tanggal :</label>
                            ...
                            for (let i = 0; i < this.checker.length; i++) {
                                ...
                                axios.post("/api/listbck", this.uplist)
                                    .then(res => {
                                        if (this.aktif.statusso === "tersedia") {
                                            this.uprso = {
                                                out_yes: parseInt(this.hitung.qty[i]) + parseInt(this.checker[i].keluar_tersedia)
                                            };
                                            ...
                                            this.uprso = {
                                                out_no: parseInt(this.hitung.qty[i]) + parseInt(this.checker[i].keluar_tdktersedia)
                                            };
                                            axios.put("/api/listrso/" + this.checker[i].id, this.uprso)
                                                .then(res => {
                                                    axios.get("/api/listrso/" + this.checker[i].id + "/edit")
