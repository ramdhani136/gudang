<template>
  <div class="container">
    ...
    <div class="row mt-2">
      ...
      <button @click="submit()" class="btn-success btn ml-1">Kirim Permintaan</button>
    </div>
          ...
          if (result.isConfirmed) {
            if (this.listpr.length > 0) {
              ...
              if (this.aplus === this.aband) {
                ...
                axios
                  .post("/api/formprice", this.upload)
                  .then((res) => {
                    for (let i = 0; i < this.listpr.length; i++) {
                      this.uplist = {
                ...
                axios
                  ...
                  .then((res) => {
                    ...
                    axios
                      ...
                      .then((res) => {
                        this.load = false;
                        swalWithBootstrapButtons.fire("Sukses!", "Berhasil menyimpan form permintaan harga.", "success");
                        this.$router.push({
                          name: "formprice",
                        });
                      });
