        ...
        submitSo(vso){
            ...
            if (result.isConfirmed) {
                ...
                if(this.aksi===this.banding){
                    ...
                    this.uploadso={nomor_so:vso.nomor_so,tanggal_kirim:vso.tanggal_kirim,keterangan:vso.keterangan,
                    distribusi:vso.distribusi,alamat:vso.alamat,lokasi:vso.lokasi,status:'Sent',id_ekspedisi:vso.id_ekspedisi};
                    ...
                    .then(res=>{
                        this.uploadso={nomor_so:vso.nomor_so,tanggal_kirim:vso.tanggal_kirim,keterangan:vso.keterangan,
                        distribusi:vso.distribusi,alamat:vso.alamat,lokasi:vso.lokasi,status:'Sent',id_ekspedisi:vso.id_ekspedisi,
                        statusso:vso.statusso,tanggal_so:vso.tanggal_so,nomor_rso:vso.nomor_rso,
                        };
