...
<!--                     <div v-if="!disabled">
            ...
            <div class="col-4">
                ...
                <div v-if="rlist.status=='Draft' || rlist.status=='Confirmed' " class="form-group">
        ...
        <div id="rsoverflow" class="row mt-2 mx-auto" v-for="rlist in form" :key="rlist.id">
            <button v-if="rlist.status=='Draft' || rlist.status=='Confirmed'" @click="showmodal()" type="button" class="btn btn-success mt-3">+ Tambah Barang</button>
            <table id="rsthead" class="table mt-2 table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th v-if="rlist.status=='Draft' || rlist.status=='Confirmed'">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="(list,index) in listrso" :key="list.nomor_rso">
                        ...
                        <td  v-if="rlist.status=='Draft' || rlist.status=='Confirmed'" style="text-align:center">
        ...
        <div  class="row mt-2"  v-for="rlist in form" :key="rlist.id">
                ...
                <router-link :to="{name:'formcreateso'}" v-if="rlist.status=='Confirmed'" class="btn-orange btn ml-3" >
                    Proses SO
                </router-link>
        </div>
        <div  class="row mt-2"  v-for="rlist in form" :key="rlist.id">
