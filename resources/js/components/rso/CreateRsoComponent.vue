<template>
    <div class="container">
        ...
        <div class="row mt-2">
                ...
                <button @click="kirimrso()" class="btn-success btn ml-1" >
                    Kirim Permintaan
                </button>
        </div>
    ...
    methods:{
        ...
        tambahList(){
            if(this.listpr.length==0){
                this.barangs={id_custprice:this.ket.id_custprice,harga:this.ket.harga,kode:this.ket.kode,nama:this.ket.nama,satuan:this.ket.satuan};
                        ...
                        if(this.cek===this.banding){
                            ...
                            .then(res=>{
                                for(let i=0;i<this.listpr.length;i++){
                                    ...
                                    ,kode_barang:this.listpr[i].kode,harga:this.listpr[i].harga,id_custprice:this.listpr[i].id_custprice,qty:this.hitung.qty[i],qty:this.hitung.qty[i]
