...
use App\Http\Resources\ReturResource;
...
class ReturController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response(new ReturResource($data),response::HTTP_CREATED);
    }
    ...
    {
        return ReturResource::collection(Retur::where('nomor_retur',$id)->get());
    }
    ...
    {
        Retur::where('nomor_retur',$id)->update($request->all());
